...
export default function Sidebar() {
  ...
  return (
    <div className={`${isOpened ? 'duration-500 ' : 'duration-500'} mt-[65px] p-2 bg-white flex-col justify-start items-start gap-5 inline-flex border-r fixed w-[16rem]`}>
                    ...
                    <div className="flex-col flex p-3 bg-white rounded-lg hover:bg-green-100">
                        <div className="justify-between inline-flex">
                            <a href="#" className="h-5 gap-3 flex">
                                ...
                                <h2 className="text-gray-500 text-sm font-medium leading-snug">Upload</h2>
                            </a>
