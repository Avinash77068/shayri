...
export default function NavBar() {
 ...
 const Submit=()=>{
  ...
  return (
    <nav className="fixed border-b border-solid border-prime-gray-200 bg-blue-400 w-full py-3 z-10" >
      <div className="container mx-auto w-full px-[3.81%] sm:px-[0px] bg-blue-400 ">
