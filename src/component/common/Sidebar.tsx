        ...
        <div className={`z-10 ${isOpened ? 'duration-500 ' : 'duration-500'} mt-[65px] p-2 bg-blue-400 text-whtie    h-full flex-col justify-start items-start gap-5 inline-flex border-r fixed w-[16rem]`}>
            ...
            <div className="w-full">
                <div className="w-full h-8 px-3 items-center flex">
                    <h6 className="text-black  text-xs font-boldld leading-4">MENU</h6>
                </div>
                <ul className="flex-col gap-1 flex">
                    <Link to='/' >
                        <a href="#">
                            <div className="flex-col flex p-3 bg-white rounded-lg hover:bg-green-100">
                                <div className="h-5 gap-3 flex">
                                    ...
                                    <h2 className="text-black  text-sm font-bold leading-snug">Home</h2>
                                </div>
                            </div>
                        </a>
                    </Link>
                    ...
                    <li>
                        <div className="flex-col flex">
                            <Link  to='/create' className="flex-col flex p-3 bg-white rounded-lg hover:bg-green-100">
                                <div className="justify-between inline-flex">
                                    <a href="#" className="h-5 gap-3 flex">
                                        <div className="relative">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <g id="Upload 02">
                                        ...
                                        <h2 className="text-black  text-sm font-bold leading-snug">Upload</h2>
                                    </a>
            ...
            <div className="w-full flex-col flex">
                <div className="h-8 px-3 items-center inline-flex">
                    <h6 className="text-black  text-xs font-boldld leading-4">SETTINGS</h6>
                </div>
                <ul className="flex-col gap-1 flex">
                        ...
                        <a href="#">
                            <div className="p-3 rounded-lg items-center inline-flex ">
                                <div className="h-5 items-center gap-3 flex">
                                    ...
                                    <h2 className="text-black  text-sm font-bold leading-snug">Profile</h2>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li className="hover:bg-green-100 rounded-lg">
                        <Link to='/alluser/' onClick={()=>dispatch(setIsOpenDropDown(false)) }>
                            <div className="p-3 rounded-lg items-center inline-flex">
                                <div className="h-5 items-center gap-3 flex">
                                    <div className="relative">
                                    ...
                                    <h2 className="text-black  text-sm font-bold leading-snug">AllUser</h2>
                                </div>
                            </div>
                        </Link>
                    </li>
                        ...
                        <a href="#">
                            <div className="p-3 rounded-lg items-center inline-flex">
                                <div className="h-5 items-center gap-3 flex">
                                    ...
                                    <h2 className="text-black  text-sm font-bold leading-snug">News</h2>
                                </div>
                            </div>
                        </a>
                    </li>
                        ...
                        <a href="#">
                            <div className="p-3 rounded-lg items-center inline-flex">
                                <div className="h-5 items-center gap-3 flex">
                                    ...
                                    <h2 className="text-black  text-sm font-bold leading-snug">Settings</h2>
                                </div>
                            </div>
                        </a>
                    </li>
                    <li className="hover:bg-red-200 rounded-lg">
                        <a href="#">
                            <div className="p-3 rounded-lg items-center inline-flex">
                                <div className="h-5 items-center gap-3 flex">
                                    <div className="relative">
                                    ...
                                    <h2 className="text-black  text-sm font-bold leading-snug">Logout</h2>
                                </div>
                            </div>
                        </a>
                    </li>
